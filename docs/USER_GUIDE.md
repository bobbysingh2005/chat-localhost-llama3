...
- Uses `/api/news` endpoint for up-to-date news

**🔍 Web Search**
- Ask general knowledge questions
- The AI will search the web for current information using `/api/search`

**🕸️ Web Scraping**
- Ask for details from a specific website
- The AI will use `/api/scrape` to extract webpage details
...
- Ask the AI for weather, news, search, scrape, time, location, math, finance, reminders, or HTTP requests.
...
- Real tools for weather, news, search, scrape, time, location, math, finance, reminders, HTTP.
